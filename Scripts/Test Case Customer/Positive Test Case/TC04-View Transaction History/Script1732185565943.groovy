...
WebUI.click(findTestObject('Object Repository/Page_XYZ Bank/div_Your Name       ---Your Name---       H_16b39a'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_XYZ Bank/a_Transaction Type'), 0)
