...
WebUI.navigateToUrl('https://globalsqa.com/angularJs-protractor/BankingProject/#/manager')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_XYZ Bank/strong_Welcome Harry Potter'), 0)
