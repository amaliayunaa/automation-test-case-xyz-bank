...
'sebelum di clik tombol date-time\r\n'
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_XYZ Bank/td_Nov 21, 2024 55610 PM'), 0)

'sebelum di clik tombol date-time'
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_XYZ Bank/td_Nov 21, 2024 55600 PM'), 0)

WebUI.click(findTestObject('Object Repository/Page_XYZ Bank/a_Date-Time'))

'sesudah di clik tombol date-time'
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_XYZ Bank/td_Nov 21, 2024 55600 PM_1'), 0)

'sesudah di clik tombol date-time'
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_XYZ Bank/td_Nov 21, 2024 55610 PM_1'), 0)
